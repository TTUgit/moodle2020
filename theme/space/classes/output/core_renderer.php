...
class core_renderer extends \core_renderer {
    ...
    public function full_header() {
        ...
        if (get_config('theme_space', 'showhintcoursehidden') == 1 && $COURSE->visible == false &&
            ...
            $html .= html_writer::tag('i', null, array('class' => 'far fa-eye-slash fa-pull-left icon d-inline-flex mr-4'));
        ...
        if (get_config('theme_space', 'showswitchedroleincourse') == 1) {
            ...
            if (is_role_switched($COURSE->id)) {
                ...
                $html .= html_writer::tag('i', null, array('class' => 'fa fa-user-circle fa-pull-left icon d-inline-flex mr-4'));
