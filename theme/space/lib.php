...
function theme_space_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    ...
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontlighteot') {
        return $theme->setting_file_serve('customfontlighteot', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontlightwoff') {
        return $theme->setting_file_serve('customfontlightwoff', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontlightwoff2') {
        return $theme->setting_file_serve('customfontlightwoff2', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontlightttf') {
        return $theme->setting_file_serve('customfontlightttf', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontlightsvg') {
        return $theme->setting_file_serve('customfontlightsvg', $args, $forcedownload, $options);        
    }  

    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontregulareot') {
        return $theme->setting_file_serve('customfontregulareot', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontregularwoff') {
        return $theme->setting_file_serve('customfontregularwoff', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontregularwoff2') {
        return $theme->setting_file_serve('customfontregularwoff2', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontregularttf') {
        return $theme->setting_file_serve('customfontregularttf', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontregularsvg') {
        return $theme->setting_file_serve('customfontregularsvg', $args, $forcedownload, $options);        
    }  

    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontmediumeot') {
        return $theme->setting_file_serve('customfontmediumeot', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontmediumwoff') {
        return $theme->setting_file_serve('customfontmediumwoff', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontmediumwoff2') {
        return $theme->setting_file_serve('customfontmediumwoff2', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontmediumttf') {
        return $theme->setting_file_serve('customfontmediumttf', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontmediumsvg') {
        return $theme->setting_file_serve('customfontmediumsvg', $args, $forcedownload, $options);        
    }  

    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontboldeot') {
        return $theme->setting_file_serve('customfontboldeot', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontboldwoff') {
        return $theme->setting_file_serve('customfontboldwoff', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontboldwoff2') {
        return $theme->setting_file_serve('customfontboldwoff2', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontboldttf') {
        return $theme->setting_file_serve('customfontboldttf', $args, $forcedownload, $options);        
    }  
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'customfontboldsvg') {
        return $theme->setting_file_serve('customfontboldsvg', $args, $forcedownload, $options);        
    }  
