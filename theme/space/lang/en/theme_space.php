...
defined('MOODLE_INTERNAL') || die();
    ...
    $string['HR3_desc'] = 'Call to action block on the front page.<br /><img src="https://assets.rosea.io/space/docs/fp-block6.jpg" class="img-fluid rounded mt-3" /><br /><br />If you want to add some custom CSS just override this class <strong>.s-special-box-bg-gradient</strong>';
    ...
    $string['configtitle'] = 'Space (1.10.0)';
    $string['nobootswatch'] = 'None';
    $string['pluginname'] = 'Space (1.10.0)';
    ...
    ***/
    ...
    $string['loginbg_desc'] = '<div class="badge badge-secondary">Recommended size: 1920x1080px</div><div class="badge badge-success"><strong>Remember</strong> to check the fied: <strong>"Show Background Image"</strong>.</div>';
    ...
    ***/
    ...
    $string['FPTeamFooterContent_desc'] = '<br /><hr class="hr-bold my-0" />';
    ...
    $string['teamslidesperrow_desc'] = 'Recommended: 1, 2, 3, max: 4<br /><hr class="hr-bold" />';
...
&#x3C;/li&#x3E;</code></pre>';
    ...
    $string['hintro'] = '<div class="d-block text-center"><br /><br />Space Moodle Theme<br /><small>by Rosea Themes</small><br /><div class="badge badge-info">version 1.10.0</div>';
    ...
    $string['cardimgheight_desc'] = '<span class="badge badge-secondary"><strong>Example:</strong> 220px</span><br /><br />How to translate <strong>"Get access"</strong>? <a href="http://docs.space.rosea.io/docs/translations/" target="_blank">Documentation →</a>'; 
...
&#x3C;/div&#x3E;
    ...
    $string['showswitchedroleincoursesetting_desc'] = 'With this setting you can choose the place where the information to which role a user has switched is being displayed. If not checked (default value), the role information will be displayed right beneath the user\'s name in the user menu (like in theme Space or Boost). If checked, this information - together with a link to switch back - will be displayed beneath the course, as this functionality is course related.';
